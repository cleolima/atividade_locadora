...
<body>
	...
	<label for="TB_LOCACAO_ID">Id da Locação</label>
	<input type="text"  name="TB_LOCACAO_ID" id="TB_LOCACAO_ID" class="form-control"value="<?php echo $tabela['TB_LOCACAO_ID'] ?>">	
	</div>	
	<div class="form-group col-md-4">
	<label for="TB_LOCACAO_TIPO">Tipo de Locação</label>
	<input type="text"  name="TB_LOCACAO_TIPO" id="TB_LOCACAO_TIPO" class="form-control" value="<?php echo $tabela['TB_LOCACAO_TIPO'] ?>">	
	</div>
	<div class="form-group col-md-2">
	<label for="TB_LOCACAO_VALOR">Valor</label>
	<input type="text"  name="TB_LOCACAO_VALOR" id="TB_LOCACAO_VALOR" class="form-control" value="<?php echo $tabela['TB_LOCACAO_VALOR'] ?>">	
	</div>
	<div class="form-group col-md-3">
	<label for="TB_LOCACAO_DT_INICIO">Data de Inicio</label>
	<input type="text"  name="TB_LOCACAO_DT_INICIO" id="TB_LOCACAO_DT_INICIO" class="form-control" value="<?php echo $tabela['TB_LOCACAO_DT_INICIO'] ?>">	
	</div>
	<div class="form-group col-md-3">
	<label for="TB_LOCACAO_DT_FIM">Data do Fim</label>
	<input type="text"  name="TB_LOCACAO_DT_FIM" id="TB_LOCACAO_DT_FIM" class="form-control" value="<?php echo $tabela['TB_LOCACAO_DT_FIM'] ?>">
	</div>
	</div>
    ...
    <input type="text"  name="TB_FUNCIONARIO_ID" id="TB_FUNCIONARIO_ID" class="form-control" value="<?php echo $tabela['TB_FUNCIONARIO_ID'] ?>">     
    </div>
